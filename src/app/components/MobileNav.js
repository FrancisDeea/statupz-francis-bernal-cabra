    ...
    return (
        <>
            ...
            <div className={styles.modal} ref={modalRef}>
                <nav>
                    <ul>
                        <li><a href="#home" onClick={handleModal}>Home</a></li>
                        <li><a href="#about" onClick={handleModal}>About</a></li>
                        <li><a href="#works" onClick={handleModal}>Our Works</a></li>
                        <li><a href="#contact" onClick={handleModal}>Contact</a></li>
